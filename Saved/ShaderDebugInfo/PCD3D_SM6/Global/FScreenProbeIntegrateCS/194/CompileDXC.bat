...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T cs_6_6 -E ScreenProbeIntegrateCS -Fc LumenScreenProbeGather.d3dasm -Fo LumenScreenProbeGather.dxil LumenScreenProbeGather
:END
PAUSE
