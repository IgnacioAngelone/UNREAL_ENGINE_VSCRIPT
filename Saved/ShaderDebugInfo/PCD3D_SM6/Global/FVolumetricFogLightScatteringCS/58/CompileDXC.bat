...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T cs_6_6 -E LightScatteringCS -Fc VolumetricFog.d3dasm -Fo VolumetricFog.dxil VolumetricFog
:END
PAUSE
