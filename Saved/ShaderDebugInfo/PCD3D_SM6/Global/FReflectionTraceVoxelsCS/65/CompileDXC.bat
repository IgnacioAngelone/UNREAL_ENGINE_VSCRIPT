...
%DXC% -HV 2021 -Zpr -O3 -auto-binding-space 0 -Wno-parentheses-equality -disable-lifetime-markers -T cs_6_6 -E ReflectionTraceVoxelsCS -Fc LumenReflectionTracing.d3dasm -Fo LumenReflectionTracing.dxil LumenReflectionTracing
:END
PAUSE
